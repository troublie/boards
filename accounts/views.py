...
def signup(request):
    if request.method == 'POST':  # aqui validamos se é um POST ou GET (post seria forms enviadas e etc)
        form = SignUpForm(request.POST)  # aqui atribuimos os dados recebidos a variavel form
        ...
        form = SignUpForm()  # instanciamos a UserCreationForm na variável form SE FOR GET (CONFORME IF LA EM CIMA)
